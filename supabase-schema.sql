...
--
-- Name: add_staff_user(text, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.add_staff_user(staff_email text, staff_name text) RETURNS public.users
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
declare
  owner_record users;
...
begin
  ...
  select * into owner_record from users where id = auth.uid() and role = 'owner';
  if not found then
  ...
  insert into users (email, name, role)
    values (staff_email, staff_name, 'staff')
...
ALTER FUNCTION public.add_staff_user(staff_email text, staff_name text) OWNER TO postgres;
...
--
-- Name: set_opening_stock_default(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.set_opening_stock_default() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    IF NEW.opening_stock = 0 AND NEW.current_stock <> 0 THEN
        NEW.opening_stock := NEW.current_stock;
    ELSIF NEW.opening_stock = 0 AND NEW.current_stock = 0 THEN
        NEW.opening_stock := 0;
    END IF;
    RETURN NEW;
END;
...
ALTER FUNCTION public.set_opening_stock_default() OWNER TO postgres;
...
--
-- Name: product_variations product_variations_product_id_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.product_variations
    ADD CONSTRAINT product_variations_product_id_name_key UNIQUE (product_id, name);
...
--
-- Name: idx_product_variations_created_by; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_product_variations_created_by ON public.product_variations USING btree (created_by);


--
-- Name: idx_product_variations_location; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_product_variations_location ON public.product_variations USING btree (location);


--
-- Name: idx_product_variations_product_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_product_variations_unit_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_product_variations_unit_id ON public.product_variations USING btree (unit_id);
...
--
-- Name: idx_sale_items_product_variation_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_sale_items_product_variation_id ON public.sale_items USING btree (product_variation_id);
...
--
-- Name: product_variations trg_set_opening_stock_default; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_set_opening_stock_default BEFORE INSERT ON public.product_variations FOR EACH ROW EXECUTE FUNCTION public.set_opening_stock_default();


--
-- Name: sale_items trg_update_stock_after_sale; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_update_stock_after_sale AFTER INSERT ON public.sale_items FOR EACH ROW EXECUTE FUNCTION public.update_stock_after_sale();
...
--
-- Name: product_variations product_variations_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.product_variations
    ADD CONSTRAINT product_variations_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.product_variations
    ADD CONSTRAINT product_variations_unit_id_fkey FOREIGN KEY (unit_id) REFERENCES public.units(id);
...
--
-- Name: sale_items sale_items_product_variation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sale_items
    ADD CONSTRAINT sale_items_product_variation_id_fkey FOREIGN KEY (product_variation_id) REFERENCES public.product_variations(id);
...
--
-- Name: sale_items All authenticated users can create sale items; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "All authenticated users can create sale items" ON public.sale_items FOR INSERT WITH CHECK ((auth.role() = 'authenticated'::text));
...
CREATE POLICY "All authenticated users can create sales" ON public.sales FOR INSERT WITH CHECK ((auth.role() = 'authenticated'::text));


--
-- Name: product_variations All authenticated users can view product variations; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "All authenticated users can view product variations" ON public.product_variations FOR SELECT USING ((auth.role() = 'authenticated'::text));


--
-- Name: products All authenticated users can view products; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "All authenticated users can view products" ON public.products FOR SELECT USING ((auth.role() = 'authenticated'::text));
...
--
-- Name: units All users can view units; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "All users can view units" ON public.units FOR SELECT USING (true);


--
-- Name: product_variations Owners can manage product variations; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Owners can manage product variations" ON public.product_variations USING ((EXISTS ( SELECT 1
   FROM public.users
  WHERE ((users.id = auth.uid()) AND (users.role = 'owner'::text)))));


--
-- Name: products Owners can manage products; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Owners can manage products" ON public.products USING ((EXISTS ( SELECT 1
   FROM public.users
  WHERE ((users.id = auth.uid()) AND (users.role = 'owner'::text)))));


--
-- Name: shop_settings Owners can manage shop settings; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: sale_items Owners can view all sale items; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Owners can view all sale items" ON public.sale_items FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.users
  WHERE ((users.id = auth.uid()) AND (users.role = 'owner'::text)))));


--
-- Name: sales Owners can view all sales; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Owners can view all sales" ON public.sales FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.users
  WHERE ((users.id = auth.uid()) AND (users.role = 'owner'::text)))));


--
-- Name: users Users can delete themselves; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can delete themselves" ON public.users FOR DELETE USING ((id = auth.uid()));


--
-- Name: users Users can insert themselves; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: sale_items Users can view items from their sales; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can view items from their sales" ON public.sale_items FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.sales
...
--
-- Name: sales Users can view their own sales; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: product_variations; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: shop_settings; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION add_staff_user(staff_email text, staff_name text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.add_staff_user(staff_email text, staff_name text) TO anon;
GRANT ALL ON FUNCTION public.add_staff_user(staff_email text, staff_name text) TO authenticated;
GRANT ALL ON FUNCTION public.add_staff_user(staff_email text, staff_name text) TO service_role;


--
-- Name: FUNCTION delete_user(target_user_id uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION set_opening_stock_default(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.set_opening_stock_default() TO anon;
GRANT ALL ON FUNCTION public.set_opening_stock_default() TO authenticated;
GRANT ALL ON FUNCTION public.set_opening_stock_default() TO service_role;


--
-- Name: FUNCTION update_stock_after_sale(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.update_stock_after_sale() TO anon;
GRANT ALL ON FUNCTION public.update_stock_after_sale() TO authenticated;
GRANT ALL ON FUNCTION public.update_stock_after_sale() TO service_role;
...
--
-- Name: SEQUENCE shop_settings_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.shop_settings_id_seq TO anon;
GRANT ALL ON SEQUENCE public.shop_settings_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.shop_settings_id_seq TO service_role;
